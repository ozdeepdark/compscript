    ...
    local version, savefile = "ULTIMATE WOOD CHOPPER BETA 0.9.4", "uwcvariables0.9.2"
     ...
     if usebonemeal == true then
      ...
      while treeNotGrown and turtle.getItemCount(2) > amountbonemealtimes + 1 do
       ...
       if not treeGrew() then
        print("Tree didnt grew with bonemeal!")
    ...
    function UWCbuildexpanded()
     ...
     if doesItDig then
      print("Place a charcoal in slot 1")
      turtle.select(1)
